...
- Helped to develop the Dnn-inference software, which is a significance analysis tool implemented with hypothesis testing
theory to analyze the significance of features.
